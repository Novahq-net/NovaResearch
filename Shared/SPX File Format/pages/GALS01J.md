# Tachyon: The Fringe GALS01J.SPX
...
- Play scene: unknown index 0, param 3
- Set/add variable: variable group 0, variable 12, subtype 0, value 4
- Set/add variable: variable group 0, variable 3, subtype 0, value 4
